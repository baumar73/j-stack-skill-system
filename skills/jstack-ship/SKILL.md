...
Declare whether a story is publication-ready, not ready, legal-review-required, or approved by a human to publish.
...
- All major story artifacts exist and the user asks if it can ship.
- A draft is about to be published or reused publicly.

## Do Not Use For

- Do not use before source map and claim ledger exist for serious factual work.
- Do not publish; gate only.

## Role in the J-Stack Newsroom

- **Skill family:** `safety`
- **Primary responsibility:** Declare whether a story is publication-ready, not ready, legal-review-required, or approved by a human to publish.
...
- tags for publication-ready/legal-review-required/no-ship
...
1. **Treating “good enough prose” as publish-ready.**
2. **Ignoring social snippets.**
3. **Confusing AI recommendation with human approval.**
...
```text
Use jstack-ship on <story/topic>.
