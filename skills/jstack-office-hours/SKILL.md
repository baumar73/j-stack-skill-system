...
description: Use when testing whether a journalism idea, public thesis, investigation lead, or commentary concept is worth pursuing before spending research or drafting effort.
version: 1.1.0
...
# J-Stack Office Hours

## Overview

Run product/editorial judgment before research: public value, audience, smallest publishable artifact, falsification standard, and next mode.
...
- A user has a hunch, outrage, lead, post idea, or investigation idea.
- A user asks if something is worth writing or investigating.

## Do Not Use For

- Do not perform deep research here.
- Do not draft the article unless the mission brief is already sharp.

## Role in the J-Stack Newsroom

- **Skill family:** `editorial-command`
- **Primary responsibility:** Run product/editorial judgment before research: public value, audience, smallest publishable artifact, falsification standard, and next mode.
...
1. Ask or infer the public value of the piece.
2. Define exact reader and desired reader change.
3. Separate news, analysis, opinion, advocacy, campaign, and investigation.
4. Name falsification criteria: what would make the thesis wrong or unfair.
5. Set the smallest publishable artifact and next J-Stack mode.
...
- `similar story hubs`
- `prior editorial-line charters`
- `topic pages and unresolved open questions`

### Writes or Proposes in GBrain

- stories/<slug>/mission
- links from mission to related topic/person/organization pages
...
1. **Starting research without knowing the reader.**
2. **Confusing personal anger with public interest.**
3. **Failing to state what would disprove the thesis.**
...
```text
Use jstack-office-hours on <story/topic>.
