---
name: jstack-copy-desk
description: Use when tightening, restructuring, headline-testing, style-checking, and copyediting a draft without changing the evidence level or editorial mission.
version: 1.1.0
...
Improve clarity, structure, voice, and readability while preserving factual and legal boundaries.
...
- A draft exists and needs professional editing.
- The user asks for headline, intro, teaser, caption, or style refinement.

## Do Not Use For

- Do not introduce new facts.
- Do not make claims stronger for punch.

## Role in the J-Stack Newsroom

- **Skill family:** `writing`
- **Primary responsibility:** Improve clarity, structure, voice, and readability while preserving factual and legal boundaries.
...
- Edited draft
- Change rationale
- Headline/teaser options
- Risky wording notes

## Workflow

1. Read the claim ledger and draft.
2. Edit for structure, clarity, active voice, rhythm, and reader path.
3. Preserve evidence labels and caveats.
4. Flag phrases that overstate or imply unsupported intent.
5. Return changed draft plus risk notes.
...
- edited draft page or version note
- timeline entry for copy-desk pass
- links to changed-risk claims if any
...
1. **Polishing away caution.**
2. **Making the headline more defamatory than the article.**
3. **Adding unsourced context during edit.**
...
```text
Use jstack-copy-desk on <story/topic>.
