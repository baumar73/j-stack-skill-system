---
name: jstack-data-journalism
description: Use when a story relies on datasets, tables, statistics, scraping outputs, budgets, filings, measurements, or repeatable quantitative analysis.
version: 1.2.0
...
# J-Stack Data Journalism

## Overview

Make data work reproducible, explainable, and safe for publication.
...
- A story contains numbers, rankings, trends, aggregate claims, or datasets.
- The user asks for data cleaning, analysis, charts, or reproducible findings.

## Do Not Use For

- Do not publish statistical claims from uninspected data.
- Do not treat correlation as causation.

## Role in the J-Stack Newsroom

- **Skill family:** `research`
- **Primary responsibility:** Make data work reproducible, explainable, and safe for publication.
...
1. Identify dataset provenance and license.
2. Create a data dictionary and cleaning log.
3. Run analysis with reproducible commands where possible.
4. Check outliers, denominators, missing data, and uncertainty.
5. Translate numbers into claim-ledger entries with safe wording.
...
- `claim ledger`
- `prior methodology notes`

### Writes or Proposes in GBrain

- dataset page
- methodology page
- links from findings to claims and sources
...
1. **Using percentages without denominators.**
2. **Ignoring missingness and selection effects.**
3. **Creating charts that imply more certainty than the data supports.**
...
```text
Use jstack-data-journalism on <story/topic>.
