...
# J-Stack OSINT Research

## Overview

Run OSINT as disciplined public-source research with provenance, legality, and uncertainty labels.
...
- A story needs public-web reconstruction of entities, networks, events, or media provenance.
- The user asks to inspect websites, public accounts, archived pages, or public posts.

## Do Not Use For

- No credential misuse, impersonation, private accounts, doxxing, harassment, malware, or evasion.
- Do not deanonymize private individuals without a strong public-interest basis and legal review.

## Role in the J-Stack Newsroom

- **Skill family:** `research`
- **Primary responsibility:** Run OSINT as disciplined public-source research with provenance, legality, and uncertainty labels.
...
- OSINT source log
- Entity/network observations
- Uncertainty notes
- Safety warnings

## Workflow

1. State lawful public-source boundary.
2. Collect public artifacts with timestamps and URLs.
3. Separate observed artifacts from inferred relationships.
4. Record uncertainty and alternative explanations.
5. Escalate risky personal-identification claims to legal/ethics review.
...
- OSINT artifact pages
- entity relationship candidate links with confidence
- tags for public-source, archived, translation-risk
...
1. **Conflating coincidence with control.**
2. **Publishing private addresses or family details unnecessarily.**
3. **Failing to separate identity match from similarity.**
...
```text
Use jstack-osint-research on <story/topic>.
