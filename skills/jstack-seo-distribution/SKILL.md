---
name: jstack-seo-distribution
description: Use when turning a publishable story into search-intent, metadata, landing-page, newsletter, and audience-development material without overstating claims.
version: 1.2.0
...
# J-Stack SEO Distribution

## Overview

Make the story discoverable and useful while keeping distribution truthful.
...
- A story is near publication and needs SEO title, meta description, slug, landing page, newsletter intro, or audience plan.

## Do Not Use For

- Do not generate clickbait that exceeds evidence.
- Do not publish automatically.

## Role in the J-Stack Newsroom

- **Skill family:** `distribution`
- **Primary responsibility:** Make the story discoverable and useful while keeping distribution truthful.
...
1. Identify reader intent and search vocabulary.
2. Generate title/meta/slug options faithful to claim ledger.
3. Map article to landing page or dossier structure.
4. Create newsletter/audience variants.
5. Run headline-vs-evidence check before handoff to ship.
...
- `claim ledger`
- `editorial line`
- `prior topic pages/search terms`

### Writes or Proposes in GBrain

- distribution package page
- links to story and campaign pages
- tags for SEO/newsletter/landing-page
...
```markdown
# jstack-seo-distribution Output
...
1. **Search-engine framing that changes the claim.**
2. **Ignoring long-tail readers.**
3. **Making social snippets more aggressive than the piece.**
...
```text
Use jstack-seo-distribution on <story/topic>.
