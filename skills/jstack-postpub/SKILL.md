---
name: jstack-postpub
description: Use after publication to monitor corrections, rebuttals, legal letters, new evidence, source rot, reader questions, follow-up stories, and GBrain timeline updates.
version: 1.1.0
author: J-Stack project for Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [jstack, post-publication, journalism, gbrain]
    related_skills: [jstack-command-center]
---

# J-Stack Post-Publication

## Overview

Keep journalism accountable after publication.
...
- New rebuttal, evidence, legal letter, correction request, or reader challenge arrives.

## Do Not Use For

- Do not silently rewrite published history.
- Do not ignore correction requests because they are hostile.

## Role in the J-Stack Newsroom

- **Skill family:** `post-publication`
- **Primary responsibility:** Keep journalism accountable after publication.
...
- Correction/update recommendation
- Follow-up plan
- Source-rot check

## Workflow

1. Record publication metadata and version.
2. Monitor or intake new rebuttals/evidence/corrections.
3. Map new material to claim ledger and ship status.
4. Recommend correction, update, editor’s note, follow-up, or no change with rationale.
5. Maintain transparent timeline.
...
- `source map`
- `ship gate`
- `reader/rebuttal pages`

### Writes or Proposes in GBrain

- postpub log
- timeline entries for publication, corrections, updates, rebuttals
- links rebuttal -> challenges claim
...
1. **Treating corrections as defeat.**
2. **Changing claims without version notes.**
3. **Missing broken sources or source rot.**
...
```text
Use jstack-postpub on <story/topic>.
