---
name: jstack-editorial-line
description: Use when an author, newsroom, or project has a public voice or worldview that should guide framing without changing evidence grades or factual findings.
version: 1.0.0
...
# J-Stack Editorial Line

## Overview

Preserve the author’s editorial tendency transparently while enforcing evidence supremacy.
...
- The work is commentary, analysis, newsletter, campaign, or branded journalism.
- The author wants a libertarian, state-critical, institutional, progressive, investigative, or other explicit posture.

## Do Not Use For

- Do not use to make facts fit ideology.
- Do not hard-code Markus’ personal voice for public users.

## Role in the J-Stack Newsroom

- **Skill family:** `editorial-command`
- **Primary responsibility:** Preserve the author’s editorial tendency transparently while enforcing evidence supremacy.
...
- Editorial Line Charter
- Allowed language
- Forbidden distortions
- Counterfacts that must be included

## Workflow

1. Ask for the desired editorial tendency and public tone.
2. Define values and moral concerns that guide emphasis.
3. List distortions the line must not commit.
4. Identify counterfacts that must be included even if inconvenient.
5. Bind drafting and social snippets to this charter.

## GBrain Integration

### Reads from GBrain

- `author/editorial-line pages`
- `prior style guide pages`
- `story mission page`

### Writes or Proposes in GBrain

- editorial-line charter page
- link from story to charter
- timeline note when a public line is changed
...
1. **Pretending to be neutral while smuggling a line.**
2. **Letting line alter evidence grades.**
3. **Making public examples depend on Markus-specific private preferences.**
...
```text
Use jstack-editorial-line on <story/topic>.
